...
const Featured = () => {
    ...
    return (
        ...
        <div className='absolute w-full px top-20 flex justify-center lg:flex-row flex-col'>
            <div className=''>
            <h2 className='text-white text-xl'>With a full range of Event Planning Services, our Clients have Successful & Prosperous Events!</h2>
            <h2 className='text-white'>We make your events smart & impactful by personalised event management services.</h2>
            </div>
        </div>
        <div className='absolute w-full px-8 lg:px-36 top-72 flex justify-center gap-40 items-center lg:flex-row flex-col'>
            <div className=''>
            <h2 className='text-white text-xl'>Services Featured</h2>
            <h2 className='text-white'>We make your events smart & impactful by personalised event management services.</h2>
